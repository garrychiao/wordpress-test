<?php
function xaver_in_array_r($needle, $haystack, $strict = false) {
 ...
 function xaver_portfolio($group, $layout, $col_layout, $filter_display_status, $custom_class){
		...
		foreach($portfolio_categories as $category): 
	        ...
	        { 
		        ...
		        foreach ($item_categories as $index => $project_cat) {
		          ...
		          if($categoryClass == $project_cat->slug && !xaver_in_array_r($categoryClass, $filter_items))
		          {
