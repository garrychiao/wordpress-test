<?php
function velten_in_array_r($needle, $haystack, $strict = false) {
 ...
 function velten_portfolio($group, $layout, $col_layout, $filter_display_status, $custom_class){
	...
	if($filter_display_status == 'yes')
	{
		...
		foreach($portfolio_categories as $category): 
	        ...
	        { 
		        ...
		        foreach ($item_categories as $index => $project_cat) {
		          ...
		          if($categoryClass == $project_cat->slug && !velten_in_array_r($categoryClass, $filter_items))
		          {
		...
		$filter_list .= '<li><a href="#" data-filter="*" class="filter-active dark active"><span>'.__('All','signaturelang').'</span></a></li>';
		...
		$filter_markup = '<section id="works-filter-panel" class="works-filter-panel signature-ebert velten-filter color-bg">
          						  <div class="valign">
